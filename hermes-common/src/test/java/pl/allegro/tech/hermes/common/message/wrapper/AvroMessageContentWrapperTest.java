...
public class AvroMessageContentWrapperTest {
    ...
    public void setup() throws IOException {
        ...
        avroRecordConverter = new AvroRecordConverter(new DefaultGenericDatumReaderFactory());
        avroMessageContentWrapper = new AvroMessageContentWrapper(Clock.systemDefaultZone(), avroRecordConverter);
    }
    ...
    public void shouldWrappedMessageContainsMetadata() throws IOException {
        ...
        // then
        GenericRecord messageWithMetadata = avroRecordConverter.avroBytesToRecord(wrappedMessage, avroUser.getSchema());
